...
func (plugin *playwrightPlugin) GetCurrentContext(ctx context.Context) (*string, error) {
	url := (*plugin.page).URL()
	return &url, nil
}
...
func (plugin *playwrightPlugin) GetMinifiedDOM(ctx context.Context) (*types.DOM, error) {
...
func (plugin *playwrightPlugin) ExtractFirstUniqueID(ctx context.Context, fragment string) (string, error) {
...
func (plugin *playwrightPlugin) IsLocatorValid(ctx context.Context, locator string) (bool, error) {
...
func (plugin *playwrightPlugin) SetViewportSize(ctx context.Context, width, height int) error {
...
func (plugin *playwrightPlugin) TakeScreenshot(ctx context.Context) ([]byte, error) {
...
func (plugin *playwrightPlugin) GetElementLocators(ctx context.Context, location *types.Location) ([]string, error) {
	if location == nil {
...
func (plugin *playwrightPlugin) GetElementLocation(ctx context.Context, locator string) (*types.Location, error) {
	result, err := plugin.evaluateExpression(
